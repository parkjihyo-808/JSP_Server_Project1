...
public enum _0203_3_ConnectionUtil {
    ...
    _0203_3_ConnectionUtil() {
        ...
        // 데이터 베이스에서 사용하는 sql 문장을 반복적으로 사용하는 것을 캐시(저장해서) 사용
        // PreparedStatement 캐싱 기능을 활성화하는 기본 옵션입니다.
        config.addDataSourceProperty("cachePrepStmts", "true");
        // 각 연결(Connection)당 캐시할 수 있는 PreparedStatement의 최대 개수
        config.addDataSourceProperty("prepStmtCacheSize", "250");
        // 캐시할 수 있는 SQL 문의 최대 길이(문자 수)
        config.addDataSourceProperty("prepStmtCacheSqlLimit", "2048");

        //HikariDataSource 클래스에 위의 설정 클래스를 담기
